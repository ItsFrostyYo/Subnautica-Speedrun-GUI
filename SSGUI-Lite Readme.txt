──────────────────────────────────────────────────────────────
      Subnautica Speedrun GUI — Lite Version (Release V1.5)
                     By ItsFrosti


SSGUI (Lite Version) provides a streamlined way to manage multiple
Subnautica versions, restart the game quickly, toggle the RNG mod,
run a customizable reset macro, and optionally enable hardcore save deletion,
...
- If **"SSGUI-Lite.exe"** fails to launch, install **AutoHotkey v1**.
